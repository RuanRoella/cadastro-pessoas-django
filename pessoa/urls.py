...
urlpatterns = [
    ...
    path('<int:pk_pessoa>/contatos/novo',login_required(views.contato_novo),name='contato.novo'),
    path('<int:pk_pessoa>/contatos/<int:pk>/editar',login_required(views.contato_editar),name='contato.editar'),
    path('<int:pk_pessoa>/contatos/<int:pk>/remover',login_required(views.contato_remover),name='contato.remover'),
]